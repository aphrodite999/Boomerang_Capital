export const MetricsTrackerAbi = [
  {
    type: "constructor",
    payable: false,
  ...
  {
    type: "function",
    name: "getTokenHoldersBondsVesting",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [],
  ...
  {
    type: "function",
    name: "getTokenHoldersLeveragePosition",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [],
  ...
  {
    type: "function",
    name: "testBonderAfterClaimingBond",
    constant: false,
    payable: false,
  ...
  {
    type: "function",
    name: "testBonderBeforePurchasingBond",
    constant: false,
    payable: false,
    inputs: [{ type: "address", name: "_userAddress" }],
    outputs: [],
  ...
  {
    type: "function",
    name: "testLeverageHolderAfterClosingPosition",
    constant: false,
    payable: false,
    inputs: [{ type: "address", name: "_userAddress" }],
    outputs: [],
  ...
  {
    type: "function",
    name: "testLeverageHolderBeforeCreatingLeverage",
    constant: false,
    payable: false,
    inputs: [{ type: "address", name: "_userAddress" }],
    outputs: [],
  ...
  {
    type: "function",
    name: "testRecipientBeforeTransfer",
    constant: false,
    payable: false,
    inputs: [{ type: "address", name: "_userAddress" }],
    outputs: [],
