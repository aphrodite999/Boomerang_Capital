export const BondingDepositoryAbi = [
  {
    type: "constructor",
    payable: false,
    inputs: [
  ...
  {
    type: "function",
    name: "activateBondTerm",
    constant: false,
    payable: false,
    inputs: [
      { type: "uint256", name: "_bondID" },
      { type: "bool", name: "_active" },
    ],
    outputs: [],
  },
  {
    ...
    payable: false,
    inputs: [
      { type: "string", name: "_assetBonded" },
      { type: "uint256", name: "_tokenPrice" },
      { type: "uint256", name: "_totalAmount" },
      { type: "uint256", name: "_vestingTerm" },
      { type: "bool", name: "_active" },
    ],
    outputs: [],
  },
  ...
  {
    type: "function",
    name: "createBondAndPullToLeverage",
    constant: false,
    payable: false,
    inputs: [
      { type: "address", name: "_userAddress" },
      { type: "uint256", name: "_tokensToBond" },
      { type: "uint256", name: "_bondID" },
    ],
    outputs: [],
  },
  {
    type: "function",
    name: "getActiveByBondID",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "uint256", name: "_bondID" }],
    outputs: [{ type: "bool" }],
  },
  {
    type: "function",
    name: "getAmountLeftByBondID",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "uint256", name: "_bondID" }],
  ...
  {
    type: "function",
    name: "getBondHolderAssetBonded",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "address", name: "_bondHolder" }],
    outputs: [{ type: "string" }],
  },
  {
    type: "function",
    name: "getBondHolderAveragePriceOfVestingBonds",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "address", name: "_bondHolder" }],
  ...
  {
    type: "function",
    name: "getBondHolderBondsClaimedToDate",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "address", name: "_bondHolder" }],
    ...
    outputs: [
      {
        type: "tuple",
        components: [
          { type: "address", name: "bondHolder" },
          { type: "uint256", name: "lastPurchasedBondID" },
          { type: "uint256", name: "tokensVesting" },
          { type: "string", name: "assetBonded" },
          { type: "uint256", name: "averagePriceOfVestingBonds" },
          { type: "uint256", name: "bondingTime" },
          { type: "uint256", name: "vestingTimeRemaining" },
          { type: "uint256", name: "bondsClaimedToDate" },
        ],
      },
    ],
  },
  ...
  {
    type: "function",
    name: "getBondHolderLastPurchasedBondID",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "address", name: "_bondHolder" }],
  ...
  {
    type: "function",
    name: "getBondHolderTokenVesting",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "address", name: "_bondHolder" }],
  ...
  {
    type: "function",
    name: "getBondHolderVestingTimeRemaining",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "address", name: "_bondHolder" }],
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { type: "string", name: "assetBonded" },
          { type: "uint256", name: "tokenPrice" },
          { type: "uint256", name: "totalAmount" },
          { type: "uint256", name: "amountLeft" },
  ...
  {
    type: "function",
    name: "getBondTermCurrentROIByID",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "uint256", name: "_bondID" }],
  ...
  {
    type: "function",
    name: "getBondingDepoTokenBalanceAvalible",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [],
  ...
  {
    type: "function",
    name: "getBondingDepoTotalTokenBalance",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [],
  ...
  {
    type: "function",
    name: "getLowestActiveBondingTermID",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [],
  ...
  {
    type: "function",
    name: "getNumberOfActiveBondingTerms",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [],
  ...
  {
    type: "function",
    name: "getTotalBondsAvalibleToBuyNow",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [],
  ...
  {
    type: "function",
    name: "getTotalBondsClaimedToDate",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [],
  ...
  {
    type: "function",
    name: "getTotalNumberOfBondingTerms",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [],
  ...
  {
    type: "function",
    name: "getUserCurrentlyBondingROIByAddress",
    constant: true,
    stateMutability: "view",
    payable: false,
    inputs: [{ type: "address", name: "_bondHolder" }],
  ...
  {
    type: "function",
    name: "ownerCreateTeamBond",
    constant: false,
    payable: false,
    inputs: [
      { type: "uint256", name: "_tokensBonded" },
      { type: "address", name: "_bondRecepientAddress" },
      { type: "uint256", name: "_vestingTerm" },
    ],
    outputs: [],
  },
  ...
  {
    type: "function",
    name: "transferTokensToBondingWallet",
    constant: false,
    payable: false,
  ...
  {
    type: "function",
    name: "transferTokensToTreasuryWallet",
    constant: false,
    payable: false,
    inputs: [{ type: "uint256", name: "_amount" }],
    outputs: [],
  ...
  {
    type: "function",
    name: "transferUSDCToBondingWallet",
    constant: false,
    payable: false,
    inputs: [{ type: "uint256", name: "_amount" }],
    outputs: [],
  ...
  {
    type: "function",
    name: "transferUSDCToTreasuryWallet",
    constant: false,
    payable: false,
    inputs: [{ type: "uint256", name: "_amount" }],
    outputs: [],
  ...
  {
    type: "function",
    name: "transferWETHToBondingWallet",
    constant: false,
    payable: false,
    inputs: [{ type: "uint256", name: "_amount" }],
    outputs: [],
  ...
  {
    type: "function",
    name: "transferWETHToTreasuryWallet",
    constant: false,
    payable: false,
    inputs: [{ type: "uint256", name: "_amount" }],
    outputs: [],
  ...
  {
    type: "function",
    name: "updateReflectionSettings",
    constant: false,
    payable: false,
    inputs: [
      { type: "bool", name: "_reflectiveBonds" },
      { type: "bool", name: "_premiumBPSReflection" },
      { type: "uint256", name: "_dividendFeeBPS" },
      { type: "uint256", name: "_liquidityFeeBPS" },
      { type: "uint256", name: "_marketingFeeBPS" },
    ],
    outputs: [],
  },
  {
